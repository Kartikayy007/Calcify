    ...
    <div className="clay-card p-4 rounded-[1.5rem] flex flex-col gap-4 w-full">
      <div className="flex justify-between items-end gap-4 w-full">
        <div className="flex flex-col gap-1">
          ...
          <span className="text-lg md:text-xl font-bold text-foreground mt-1 flex items-center">
        ...
        <div className="flex flex-col gap-1 items-end text-right">
          ...
          <span className="text-lg md:text-xl font-bold text-foreground mt-1 flex items-center justify-end w-full">
