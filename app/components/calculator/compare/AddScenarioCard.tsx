...
export function AddScenarioCard({ onClick }: AddScenarioCardProps) {
  return (
    <div
      onClick={onClick}
      className="h-full mt-4 p-5 rounded-3xl flex flex-col items-center justify-center cursor-pointer bg-foreground/[0.03] hover:bg-foreground/[0.06] transition-all duration-300 border-[3px] border-dashed border-foreground/20 group"
    >
